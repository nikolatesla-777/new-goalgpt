...
var MatchLineupService = /** @class */ (function () {
    function MatchLineupService() {
        this.client = TheSportsAPIManager_1.theSportsAPI;
    }
    /**
     * Get match lineup with cache support
     */
    MatchLineupService.prototype.getMatchLineup = function (params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        cacheKey = "".concat(types_1.CacheKeyPrefix.TheSports, ":match:lineup:").concat(match_id);
                        return [4 /*yield*/, cache_service_1.cacheService.get(cacheKey)];
                    case 1:
                        cached = _a.sent();
                        if (cached) {
                            logger_1.logger.debug("Cache hit for match lineup: ".concat(cacheKey));
                            return [2 /*return*/, cached];
                        }
                        logger_1.logger.info("Fetching match lineup: ".concat(match_id));
                        return [4 /*yield*/, this.client.get('/match/lineup/detail', { match_id: match_id })];
                    case 2:
                        response = _a.sent();
