...
var MatchPlayerStatsService = /** @class */ (function () {
    function MatchPlayerStatsService() {
        this.client = TheSportsAPIManager_1.theSportsAPI;
    }
    /**
     * Get match player stats with cache support
     */
    MatchPlayerStatsService.prototype.getMatchPlayerStats = function (params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        cacheKey = "".concat(types_1.CacheKeyPrefix.TheSports, ":match:player_stats:").concat(match_id);
                        return [4 /*yield*/, cache_service_1.cacheService.get(cacheKey)];
                    case 1:
                        cached = _a.sent();
                        if (cached) {
                            logger_1.logger.debug("Cache hit for match player stats: ".concat(cacheKey));
                            return [2 /*return*/, cached];
                        }
                        logger_1.logger.info("Fetching match player stats: ".concat(match_id));
                        return [4 /*yield*/, this.client.get('/match/player_stats/list', { match_id: match_id })];
                    case 2:
                        response = _a.sent();
    ...
    return MatchPlayerStatsService;
}());
