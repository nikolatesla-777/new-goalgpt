...
var MatchHalfStatsService = /** @class */ (function () {
    function MatchHalfStatsService() {
     ...
     */
    MatchHalfStatsService.prototype.getMatchHalfStatsDetail = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var match_id, cacheKey, cached, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        match_id = params.match_id;
                        cacheKey = "".concat(types_1.CacheKeyPrefix.TheSports, ":match:half_stats:detail:").concat(match_id);
                        return [4 /*yield*/, cache_service_1.cacheService.get(cacheKey)];
                    case 1:
                        cached = _a.sent();
                        if (cached) {
                            logger_1.logger.debug("Cache hit for match half stats detail: ".concat(cacheKey));
                            return [2 /*return*/, cached];
                        }
                        logger_1.logger.info("Fetching match half stats detail: ".concat(match_id));
                        return [4 /*yield*/, this.client.get('/match/half/team_stats/detail', { match_id: match_id })];
                    case 2:
                        response = _a.sent();
