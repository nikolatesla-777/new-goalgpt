...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await db.schema
    ...
    .addColumn('provider', sql.raw('varchar(20)'), (col) => col.notNull())
    .addColumn('provider_user_id', sql.raw('varchar(255)'), (col) => col.notNull())
    .addColumn('email', sql.raw('varchar(255)'))
    .addColumn('display_name', sql.raw('varchar(255)'))
  ...
  await db.schema
    ...
    .addColumn('level', sql.raw('varchar(20)'), (col) => col.notNull().defaultTo('bronze'))
    .addColumn('level_progress', sql.raw('decimal(5,2)'), (col) => col.defaultTo(0.00))
  ...
  await db.schema
    ...
    .addColumn('transaction_type', sql.raw('varchar(50)'), (col) => col.notNull())
    .addColumn('reference_id', 'uuid')
    .addColumn('reference_type', sql.raw('varchar(50)'))
  ...
  await db.schema
    .createTable('badges')
    .addColumn('id', 'uuid', (col) => col.primaryKey().defaultTo(sql`uuid_generate_v4()`))
    .addColumn('slug', sql.raw('varchar(100)'), (col) => col.notNull().unique())
    .addColumn('name_tr', sql.raw('varchar(255)'), (col) => col.notNull())
    .addColumn('name_en', sql.raw('varchar(255)'), (col) => col.notNull())
    .addColumn('description_tr', 'text')
    .addColumn('description_en', 'text')
    .addColumn('icon_url', 'text', (col) => col.notNull())
    .addColumn('category', sql.raw('varchar(50)'), (col) => col.notNull())
    .addColumn('rarity', sql.raw('varchar(20)'), (col) => col.notNull().defaultTo('common'))
  ...
  await db.schema
    ...
    .addColumn('ad_network', sql.raw('varchar(50)'), (col) => col.notNull())
    .addColumn('ad_unit_id', sql.raw('varchar(255)'), (col) => col.notNull())
    .addColumn('ad_type', sql.raw('varchar(50)'), (col) => col.notNull())
    .addColumn('reward_amount', 'integer', (col) => col.notNull())
    .addColumn('reward_granted', 'boolean', (col) => col.defaultTo(false))
    .addColumn('device_id', sql.raw('varchar(255)'))
  ...
  await db.schema
    ...
    .addColumn('id', 'uuid', (col) => col.primaryKey().defaultTo(sql`uuid_generate_v4()`))
    .addColumn('referrer_user_id', 'uuid', (col) =>
      col.references('customer_users.id').onDelete('cascade').notNull()
    )
    .addColumn('referred_user_id', 'uuid', (col) =>
      col.references('customer_users.id').onDelete('cascade').notNull().unique()
    )
    .addColumn('referral_code', sql.raw('varchar(20)'), (col) => col.notNull())
    .addColumn('status', sql.raw('varchar(20)'), (col) => col.notNull().defaultTo('pending'))
    ...
    .addColumn('created_at', 'timestamptz', (col) => col.defaultTo(sql`NOW()`))
    .addColumn('expires_at', 'timestamptz', (col) => col.defaultTo(sql`NOW() + INTERVAL '30 days'`))
    .execute();
  ...
  await db.schema
    ...
    .addColumn('business_name', sql.raw('varchar(255)'), (col) => col.notNull())
    .addColumn('tax_id', sql.raw('varchar(50)'))
    .addColumn('phone', sql.raw('varchar(20)'), (col) => col.notNull())
    .addColumn('email', sql.raw('varchar(255)'), (col) => col.notNull())
    .addColumn('address', 'text')
    .addColumn('status', sql.raw('varchar(20)'), (col) => col.notNull().defaultTo('pending'))
    .addColumn('commission_rate', sql.raw('decimal(5,2)'), (col) => col.defaultTo(20.00))
    .addColumn('referral_code', sql.raw('varchar(20)'), (col) => col.notNull().unique())
    .addColumn('total_referrals', 'integer', (col) => col.defaultTo(0))
    .addColumn('total_subscriptions', 'integer', (col) => col.defaultTo(0))
    .addColumn('total_revenue', sql.raw('decimal(10,2)'), (col) => col.defaultTo(0.00))
    .addColumn('total_commission', sql.raw('decimal(10,2)'), (col) => col.defaultTo(0.00))
  ...
  await db.schema
    ...
    .addColumn('partner_id', 'uuid', (col) =>
      col.references('partners.id').onDelete('cascade').notNull()
    )
    .addColumn('date', 'date', (col) => col.notNull())
    .addColumn('new_signups', 'integer', (col) => col.defaultTo(0))
    .addColumn('new_subscriptions', 'integer', (col) => col.defaultTo(0))
    .addColumn('revenue', sql.raw('decimal(10,2)'), (col) => col.defaultTo(0.00))
    .addColumn('commission', sql.raw('decimal(10,2)'), (col) => col.defaultTo(0.00))
  ...
  await db.schema
    ...
    .addColumn('parent_comment_id', 'uuid', (col) =>
      col.references('match_comments.id').onDelete('cascade')
    )
    ...
    .addColumn('status', sql.raw('varchar(20)'), (col) => col.defaultTo('active'))
    .addColumn('created_at', 'timestamptz', (col) => col.defaultTo(sql`NOW()`))
    .addColumn('updated_at', 'timestamptz', (col) => col.defaultTo(sql`NOW()`))
    .addColumn('deleted_at', 'timestamptz')
    .execute();
  ...
  await db.schema
    ...
    .addColumn('comment_id', 'uuid', (col) =>
      col.references('match_comments.id').onDelete('cascade').notNull()
    )
    .addColumn('customer_user_id', 'uuid', (col) =>
      col.references('customer_users.id').onDelete('cascade').notNull()
    )
  ...
  await db.schema
    ...
    .addColumn('reward_type', sql.raw('varchar(50)'), (col) => col.notNull())
    .addColumn('reward_amount', 'integer', (col) => col.notNull())
    .addColumn('claimed_at', 'timestamptz', (col) => col.defaultTo(sql`NOW()`))
    .execute();
  ...
  await db.schema
    ...
    .addColumn('id', 'uuid', (col) => col.primaryKey().defaultTo(sql`uuid_generate_v4()`))
    .addColumn('slug', sql.raw('varchar(255)'), (col) => col.notNull().unique())
    .addColumn('title_tr', sql.raw('varchar(500)'), (col) => col.notNull())
    .addColumn('title_en', sql.raw('varchar(500)'))
    .addColumn('content_tr', 'text', (col) => col.notNull())
    .addColumn('content_en', 'text')
    .addColumn('excerpt_tr', sql.raw('varchar(500)'))
    .addColumn('excerpt_en', sql.raw('varchar(500)'))
    .addColumn('cover_image_url', 'text')
    .addColumn('category', sql.raw('varchar(50)'))
    .addColumn('tags', sql`TEXT[]`)
    .addColumn('author_id', 'uuid', (col) => col.references('customer_users.id'))
    .addColumn('status', sql.raw('varchar(20)'), (col) => col.defaultTo('draft'))
  ...
  await db.schema
    ...
    .addColumn('id', 'uuid', (col) => col.primaryKey().defaultTo(sql`uuid_generate_v4()`))
    .addColumn('name', sql.raw('varchar(255)'), (col) => col.notNull().unique())
    .addColumn('title_tr', sql.raw('varchar(255)'), (col) => col.notNull())
    .addColumn('title_en', sql.raw('varchar(255)'))
    .addColumn('body_tr', 'text', (col) => col.notNull())
    .addColumn('body_en', 'text')
    .addColumn('deep_link_type', sql.raw('varchar(50)'))
    .addColumn('deep_link_params', 'jsonb', (col) => col.defaultTo(sql`'{}'::jsonb`))
    .addColumn('icon_url', 'text')
    .addColumn('image_url', 'text')
    .addColumn('target_audience', sql.raw('varchar(50)'), (col) => col.defaultTo('all'))
  ...
  await db.schema
    ...
    .addColumn('status', sql.raw('varchar(20)'), (col) => col.defaultTo('pending'))
