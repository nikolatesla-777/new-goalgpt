 ...
 */
function getStageModeName(mode, lang) {
    var _a;
    var _b;
    if (lang === void 0) { lang = 'en'; }
    var names = (_a = {},
        _a[StageMode.POINTS] = { en: 'Points', tr: 'Puan Sistemi' },
        _a[StageMode.ELIMINATION] = { en: 'Elimination', tr: 'Eleme Sistemi' },
        _a);
    return ((_b = names[mode]) === null || _b === void 0 ? void 0 : _b[lang]) || 'Unknown';
}
/**
