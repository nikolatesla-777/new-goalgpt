...
exports.LIVE_STATUSES_SQL = exports.LIVE_STATUSES = exports.MatchState = void 0;
 ...
 */
exports.LIVE_STATUSES = [2, 3, 4, 5, 7];
/**
...
function isDefinitelyFinished(state, lastStatus8Time) {
    ...
    if (state === MatchState.END) {
        ...
        if (lastStatus8Time) {
            var minutesSinceStatus8 = (Date.now() - lastStatus8Time) / (1000 * 60);
