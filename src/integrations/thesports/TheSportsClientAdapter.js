 ...
 */
var TheSportsClientAdapter = /** @class */ (function () {
    function TheSportsClientAdapter(client) {
        this.client = client || TheSportsClient_1.theSportsClient;
    }
    TheSportsClientAdapter.prototype.get = function (endpoint_1) {
        return __awaiter(this, arguments, void 0, function (endpoint, params, options) {
            if (params === void 0) { params = {}; }
            if (options === void 0) { options = {}; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.get(endpoint, params, options)];
            });
        });
    };
    TheSportsClientAdapter.prototype.post = function (endpoint_1, data_1) {
        return __awaiter(this, arguments, void 0, function (endpoint, data, params) {
            if (params === void 0) { params = {}; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.post(endpoint, data, params)];
            });
        });
    };
    TheSportsClientAdapter.prototype.getHealth = function () {
        var health = this.client.getHealth();
        return {
    ...
    TheSportsClientAdapter.prototype.isAvailable = function () {
        return this.client.isAvailable();
    };
    TheSportsClientAdapter.prototype.resetCircuit = function () {
     ...
     */
    TheSportsClientAdapter.prototype.getClient = function () {
        return this.client;
    };
    return TheSportsClientAdapter;
}());
