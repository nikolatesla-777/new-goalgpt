...
var JWT_ACCESS_TOKEN_EXPIRES_IN = process.env.JWT_ACCESS_TOKEN_EXPIRES_IN || '1h';
var JWT_REFRESH_TOKEN_EXPIRES_IN = process.env.JWT_REFRESH_TOKEN_EXPIRES_IN || '30d';
...
var EFFECTIVE_JWT_REFRESH_SECRET = JWT_REFRESH_SECRET;
/**
...
function generateTokens(payload) {
    ...
    var accessToken = jsonwebtoken_1.default.sign(payload, EFFECTIVE_JWT_SECRET, {
    ...
    var decoded = jsonwebtoken_1.default.decode(accessToken);
    var expiresIn = decoded.exp - decoded.iat;
    return {
...
function verifyAccessToken(token) {
    try {
        var decoded = jsonwebtoken_1.default.verify(token, EFFECTIVE_JWT_SECRET);
        return decoded;
    }
    catch (error) {
...
function verifyRefreshToken(token) {
    try {
        var decoded = jsonwebtoken_1.default.verify(token, EFFECTIVE_JWT_REFRESH_SECRET);
