...
describe('PR-5B: TheSportsClient Adapter Migration (CI-Safe)', () => {
    ...
    describe('MatchDiaryService', () => {
        it('should return valid match diary response structure', async () => {
            ...
            global.fetch.mockResolvedValueOnce(createMockResponse(mockMatchDiaryResponse));
            const service = new matchDiary_service_1.MatchDiaryService();
        ...
        it('should handle API errors gracefully', async () => {
            ...
            global.fetch.mockResolvedValue(createMockResponse(mockEmptyResponse));
            const service = new matchDiary_service_1.MatchDiaryService();
        ...
        it('should handle network failures gracefully', async () => {
            ...
            await expect(service.getMatchDiary({ date: today })).rejects.toThrow();
        }, 15000);
    });
    describe('CompetitionService', () => {
        it('should return valid competition list response structure', async () => {
            ...
            global.fetch.mockResolvedValueOnce(createMockResponse(mockCompetitionResponse));
            const service = new competition_service_1.CompetitionService();
        ...
        it('should handle API errors gracefully', async () => {
            ...
            global.fetch.mockResolvedValueOnce(createMockResponse(mockErrorResponse));
            const service = new competition_service_1.CompetitionService();
            const response = await service.getCompetitionList();
    ...
    describe('TheSportsAPIAdapter', () => {
        it('should be available and healthy', () => {
            const health = thesports_1.theSportsAPIAdapter.getHealth();
        ...
        it('should report circuit breaker state', () => {
            const isAvailable = thesports_1.theSportsAPIAdapter.isAvailable();
