...
async function runLiveSmokeTest() {
    ...
    try {
        ...
        const matchService = new matchDiary_service_1.MatchDiaryService();
        ...
        if (diaryResponse.results && diaryResponse.results.length > 0) {
            const firstMatch = diaryResponse.results[0];
        ...
        const compService = new competition_service_1.CompetitionService();
        ...
        const finalHealth = thesports_1.theSportsAPIAdapter.getHealth();
