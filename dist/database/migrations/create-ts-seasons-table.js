...
exports.createTsSeasonsTable = createTsSeasonsTable;
const connection_1 = require("../connection");
const logger_1 = require("../../utils/logger");
async function createTsSeasonsTable() {
    ...
    `);
        ...
        logger_1.logger.info('✅ ts_seasons table created successfully');
    }
    catch (error) {
        await client.query('ROLLBACK');
        logger_1.logger.error('❌ Failed to create ts_seasons table:', error);
        throw error;
    }
    finally {
        client.release();
