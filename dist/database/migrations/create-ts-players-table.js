...
exports.createTsPlayersTable = createTsPlayersTable;
const connection_1 = require("../connection");
const logger_1 = require("../../utils/logger");
async function createTsPlayersTable() {
    ...
    `);
        ...
        logger_1.logger.info('✅ ts_players table created successfully');
    }
    catch (error) {
        await client.query('ROLLBACK');
        logger_1.logger.error('❌ Failed to create ts_players table:', error);
        throw error;
    }
    finally {
        client.release();
