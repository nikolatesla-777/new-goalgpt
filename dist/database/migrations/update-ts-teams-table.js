...
exports.updateTsTeamsTable = updateTsTeamsTable;
const connection_1 = require("../connection");
const logger_1 = require("../../utils/logger");
async function updateTsTeamsTable() {
    ...
    `);
        ...
        logger_1.logger.info('✅ ts_teams table updated successfully');
    }
    catch (error) {
        await client.query('ROLLBACK');
        logger_1.logger.error('❌ Failed to update ts_teams table:', error);
        throw error;
    }
    finally {
        client.release();
