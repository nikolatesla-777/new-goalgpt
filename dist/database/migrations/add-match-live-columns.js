...
exports.addMatchLiveColumns = addMatchLiveColumns;
const connection_1 = require("../connection");
const logger_1 = require("../../utils/logger");
async function addMatchLiveColumns() {
    ...
    `);
        ...
        logger_1.logger.info('✅ Live match columns added to ts_matches table successfully');
    }
    catch (error) {
        await client.query('ROLLBACK');
        logger_1.logger.error('❌ Failed to add live match columns to ts_matches table:', error);
        throw error;
    }
    finally {
        client.release();
