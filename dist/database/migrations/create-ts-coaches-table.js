...
exports.createTsCoachesTable = createTsCoachesTable;
const connection_1 = require("../connection");
const logger_1 = require("../../utils/logger");
async function createTsCoachesTable() {
    ...
    `);
        ...
        logger_1.logger.info('✅ ts_coaches table created successfully');
    }
    catch (error) {
        await client.query('ROLLBACK');
        logger_1.logger.error('❌ Failed to create ts_coaches table:', error);
        throw error;
    }
    finally {
        client.release();
