...
exports.updateTsCompetitionsTable = updateTsCompetitionsTable;
const connection_1 = require("../connection");
const logger_1 = require("../../utils/logger");
async function updateTsCompetitionsTable() {
    ...
    `);
        ...
        logger_1.logger.info('✅ ts_competitions table updated successfully');
    }
    catch (error) {
        await client.query('ROLLBACK');
        logger_1.logger.error('❌ Failed to update ts_competitions table:', error);
        throw error;
    }
    finally {
        client.release();
