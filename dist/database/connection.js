...
const isSupabase = ((_a = process.env.DB_HOST) === null || _a === void 0 ? void 0 : _a.includes('supabase')) || ((_b = process.env.DB_HOST) === null || _b === void 0 ? void 0 : _b.includes('pooler'));
const pool = new pg_1.Pool(Object.assign({ host: process.env.DB_HOST || 'localhost', port: parseInt(process.env.DB_PORT || '5432'), database: process.env.DB_NAME || 'goalgpt', user: process.env.DB_USER || 'postgres', password: process.env.DB_PASSWORD || '', max: parseInt(process.env.DB_MAX_CONNECTIONS || '25'), min: 5, idleTimeoutMillis: 60000, connectionTimeoutMillis: 15000, 
    ...
    for (let attempt = 0; attempt <= retries; attempt++) {
        ...
        try {
            ...
            const isConnectionError = err.code === 'ECONNRESET' ||
                err.code === 'ETIMEDOUT' ||
                err.code === 'ENOTFOUND' ||
                ((_a = err.message) === null || _a === void 0 ? void 0 : _a.includes('Connection terminated')) ||
                ((_b = err.message) === null || _b === void 0 ? void 0 : _b.includes('timeout')) ||
                ((_c = err.message) === null || _c === void 0 ? void 0 : _c.includes('connect'));
