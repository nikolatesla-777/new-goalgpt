    ...
    return (
        <div className="admin-page">
            <div className="admin-header">
                <div>
                    <h1>Manuel Canlı Tekli Tahminler</h1>
                    <p className="subtitle">Canlı maçlara manuel tahmin ekleyin ve yönetin</p>
                </div>
                ...
                <table className="admin-table">
                    ...
                    <tbody>
                        {loading ? (
                            ...
                            <tr><td colSpan={8} className="text-center">Henüz manuel tahmin yok.</td></tr>
                        ) : (
                            predictions
                                .filter(p => !searchTerm ||
                                    ...
                                    <tr key={p.id}>
                                        ...
                                        <td>
                                            <div className="actions">
                                                {/* Edit/Delete implementation skipped for MVP */}
                ...
                <div className="modal-overlay">
                    <div className="modal-content large">
                        <div className="modal-header">
                            <h2>Yeni Tahmin Oluştur <span className="live-count">{liveMatches.length} canlı maç</span></h2>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="modal-actions">
                                <button type="button" className="admin-btn secondary" onClick={() => setShowCreateModal(false)}>iptal</button>
