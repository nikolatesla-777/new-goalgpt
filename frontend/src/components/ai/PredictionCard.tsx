...
export function PredictionCard({ prediction, isVip = false, isFavorite = false, onToggleFavorite, botStats }: PredictionCardProps) {
    ...
    return (
        <>
            ...
            >
                {/* Live Match Banner - Only for PENDING predictions with live data */}
                {isPending && prediction.live_match_status && (prediction.live_match_status === 2 || prediction.live_match_status === 4) && (
